            ...
            Row(
              ...
              children: <Widget>[
                DropdownButton<String>(
                  ...
                  items: cardList.map<DropdownMenuItem<String>>((String value) {
                ...
                DropdownButton<String>(
                  ...
                  items:
                      amountList.map<DropdownMenuItem<String>>((String value) {
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Text(value),
                    );
                ...
                DropdownButton<String>(
                  ...
                  items:
                      messageType.map<DropdownMenuItem<String>>((String value) {
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Text(value),
                    );
